...
<head>
<meta charset="UTF-8">
<title>تنظيم الحاسوب</title>
<style>
/* نفس التصميم كما في صفحة الشبكات */
...
<div class="breadcrumb">
  <a href="materials.html">المواد</a> / تنظيم الحاسوب
</div>
...
<div class="content">
    <h1>تنظيم الحاسوب</h1>
    <ul>
        <li>مكونات الحاسوب الأساسية: المعالج، الذاكرة، اللوحة الأم.</li>
        <li>الذاكرة والتخزين: RAM، ROM، وحدات التخزين الداخلية والخارجية.</li>
        <li>المعالج ووحدة التحكم: CPU ووحدة التحكم للتحكم بعمليات الحاسوب.</li>
        <li>أنظمة التشغيل ووظائفها: إدارة الموارد وتشغيل التطبيقات.</li>
        <li>مبادئ الإدخال والإخراج: التعامل مع أجهزة الإدخال مثل الكيبورد والفأرة، وأجهزة الإخراج مثل الشاشة والطابعة.</li>
    </ul>
</div>
