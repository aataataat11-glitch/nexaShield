...
<div class="breadcrumb">
  <a href="materials.html">المواد</a> / نظم التشغيل
</div>
...
<div class="content">
    <h1>نظم التشغيل</h1>
    <ul>
        <li>تعريف نظم التشغيل ووظائفها: إدارة الموارد وتشغيل التطبيقات.</li>
        <li>أنواع نظم التشغيل: Windows، Linux، MacOS.</li>
        <li>إدارة الملفات والذاكرة: تنظيم تخزين البيانات واستخدام الذاكرة بفعالية.</li>
        <li>المعالجات المتعددة والخيوط: تحسين أداء البرامج عن طريق تعدد المعالجات.</li>
        <li>الأمان والتحكم في المستخدمين: حماية البيانات وتحديد صلاحيات المستخدمين.</li>
    </ul>
</div>
