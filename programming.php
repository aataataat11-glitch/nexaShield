...
<title>البرمجة</title>
<style>
/* نفس التصميم كما في الصفحات السابقة */
...
<div class="breadcrumb">
  <a href="materials.html">المواد</a> / البرمجة
</div>
...
<div class="content">
    <h1>نظم التشغيل</h1>
    <ul>
        <li>تعريف البرمجة:البرمجة هي عملية تصميم وكتابة وتنفيذ مجموعة من الأوامر والتعليمات التي تمكّن الحاسوب من أداء مهام محددة وحل المشكلات بطريقة منطقية.</li>
        <li> لغات البرمجة هي الوسيلة التي يتواصل بها المبرمج مع الحاسوب، وتنقسم إلى:</li>
        <li>1-لغات عالية المستوى: مثل Python وJava، سهلة التعلم وقريبة من لغة الإنسان.</li>
        <li>2-لغات منخفضة المستوى: مثل C وAssembly، أقرب للغة الآلة وتُستخدم في الأنظمة والبرامج الحساسة.</li>
        <li>البرمجة الكائنية:تعتمد على تقسيم البرنامج إلى كائنات تحتوي على بيانات ودوال، مما يجعل الكود أكثر تنظيمًا، قابلية لإعادة الاستخدام، وأسهل في الصيانة.</li>
        <li>البرمجة التزامنية :تمكّن البرنامج من تنفيذ عدة مهام في نفس الوقت باستخدام الخيوط (Threads)، مما يحسن الأداء خصوصًا في البرامج الكبيرة.</li>
        <li>اختبار البرامج:يهدف إلى اكتشاف الأخطاء وتصحيحها قبل تشغيل البرنامج النهائي، لضمان جودة البرنامج واستقراره.</li>
        <li>صيانة وتطوير البرامج : تشمل تحديث البرامج، تحسين الأداء، إضافة ميزات جديدة، وضمان الأمان والاستمرارية.</li>
    </ul>
</div>
