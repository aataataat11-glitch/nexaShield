...
<div class="breadcrumb">
  <a href="materials.html">المواد</a> / التشفير
</div>
...
<div class="content">
    <h1>التشفير</h1>
    <ul>
        <li>تعريف التشفير وأنواعه: حماية البيانات عن طريق تحويلها إلى صيغة غير قابلة للقراءة.</li>
        <li>التشفير المتماثل وغير المتماثل: استخدام مفتاح واحد أو مفتاحين لتشفير وفك التشفير.</li>
        <li>خوارزميات التشفير الشائعة: AES، RSA، DES.</li>
        <li>تأمين البيانات أثناء النقل: حماية البيانات على الإنترنت أو الشبكات الداخلية.</li>
        <li>التوقيع الرقمي والشهادات الرقمية: التحقق من هوية المرسل وسلامة البيانات.</li>
    </ul>
</div>
