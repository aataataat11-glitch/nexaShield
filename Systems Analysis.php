...
<head>
<meta charset="UTF-8">
<title>تحليل وتصميم النظم</title>
<style>
...
<div class="breadcrumb">
  <a href="materials.html">المواد</a> / تحليل وتصميم النظم
</div>
...
<div class="content">
    <h1>تحليل وتصميم النظم</h1>
    <p>تحليل وتصميم النظم هو عملية دراسة النظام الحالي وتحديد متطلباته ثم تصميم حلول فعّالة لتطويره.</p>

    <h2>خطوات تحليل وتصميم النظم</h2>
    <ul>
        <li>جمع المتطلبات (Requirements Gathering)</li>
        <li>تحليل النظام (System Analysis)</li>
        <li>تصميم النظام (System Design)</li>
        <li>التنفيذ (Implementation)</li>
        <li>الاختبار (Testing)</li>
    </ul>

    <h2>الأدوات</h2>
    <ul>
        <li>مخططات UML (Use Case, Class, Sequence)</li>
        <li>مخططات تدفق البيانات (DFD)</li>
    </ul>
    ...
    <h2>الأهداف</h2>
    <ul>
        <li>تحسين الكفاءة وتقليل الأخطاء</li>
        <li>ضمان تلبية احتياجات المستخدم</li>
    </ul>
</div>
