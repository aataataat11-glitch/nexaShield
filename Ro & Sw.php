...
<div class="breadcrumb">
  <a href="materials.html">المواد</a> / التوجيه والتبديل
</div>
...
<div class="content">
    <h1>التوجيه والتبديل</h1>
    <p>التوجيه والتبديل هي تقنيات لإدارة حركة البيانات بين الشبكات وربط الأجهزة المختلفة.</p>

    <h2>التوجيه (Routing)</h2>
    <ul>
        <li>التوجيه الثابت (Static Routing)</li>
        <li>التوجيه الديناميكي (Dynamic Routing) مثل RIP و OSPF و BGP</li>
    </ul>

    <h2>التبديل (Switching)</h2>
    <ul>
        <li>الفرق بين Switch و Hub</li>
        <li>VLANs لتقسيم الشبكة</li>
        <li>Spanning Tree Protocol لمنع الحلقات في الشبكة</li>
    </ul>

    <h2>العناوين والأمان</h2>
    <ul>
        <li>IP Address و MAC Address</li>
        <li>Access Control Lists (ACLs) و Port Security</li>
    </ul>

    <h2>تطبيقات عملية</h2>
    <ul>
        <li>إعداد شبكات LAN و WAN</li>
        <li>تحسين الأداء ومنع التضارب في الشبكة</li>
    </ul>
</div>
