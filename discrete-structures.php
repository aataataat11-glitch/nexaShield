...
<div class="breadcrumb">
  <a href="materials.php">المواد</a> / الهياكل المتقطعة
</div>
...
<div class="content">
    <h1>الهياكل المتقطعة</h1>
    <p>الهياكل المتقطعة هي طريقة تقسيم البيانات أو البرامج إلى أجزاء مستقلة لتسهيل الإدارة وتحسين الأداء.</p>

    <h2>التطبيقات</h2>
    <ul>
        <li>إدارة الذاكرة في أنظمة التشغيل</li>
        <li>تقسيم البرامج الكبيرة إلى وحدات (Modules)</li>
    </ul>
    ...
    <h2>أمثلة عملية</h2>
    <ul>
        <li>تقسيم البرامج في لغات مثل C</li>
        <li>إدارة ذاكرة الحاسوب والعمليات المتعددة</li>
    </ul>
</div>
