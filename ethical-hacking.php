...
<div class="breadcrumb">
  <a href="materials.html">المواد</a> / الهاكر الأخلاقي
</div>
...
<div class="content">
    <h1>الهاكر الأخلاقي</h1>
    <p>الهاكر الأخلاقي هو الشخص الذي يستخدم مهاراته في اختبار أمان الأنظمة بطريقة قانونية لتحسين الحماية.</p>

    <h2>المهارات الأساسية</h2>
    <ul>
        <li>فهم شبكات الحاسوب</li>
        <li>التشفير والأمان السيبراني</li>
        <li>أنظمة التشغيل والخوادم</li>
    </ul>

    <h2>أدوات الهاكر الأخلاقي</h2>
    <ul>
        <li>Nmap لمسح الشبكات</li>
        <li>Wireshark لمراقبة الحركة الشبكية</li>
        <li>Metasploit لاختبار الثغرات</li>
    </ul>

    <h2>الأهداف</h2>
    <ul>
        <li>كشف الثغرات قبل استغلالها</li>
        <li>تحسين أمان الشبكات والأنظمة</li>
        <li>التأكد من الالتزام بالمعايير القانونية</li>
    </ul>

    <h2>الممارسات الأخلاقية</h2>
    <ul>
        <li>الحصول على إذن قبل الاختبار</li>
        <li>تقديم تقارير مفصلة عن الثغرات</li>
        <li>عدم التسبب بأضرار للأنظمة</li>
    </ul>
</div>
